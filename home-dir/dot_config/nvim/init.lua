...
if vim.g.vscode then
  ...
  -- File Explorer mappings / swithcing buffers
  -- <leader>e to open netrw file explorer
  vim.keymap.set('n', '<leader>e', vim.cmd.Ex, { desc = 'Open file explorer (netrw)' })
  -- Go to previous file buffer (like a toggle)
  -- vim.keymap.set('n', '<leader>b', '<C-^>', { desc = 'Toggle to last buffer' })
  -- Go to next buffer in the list
  -- vim.keymap.set('n', '<leader>n', ':bnext<CR>', { desc = 'Next buffer' })
  -- Go to previous buffer in the list
