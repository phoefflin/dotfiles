...
if [ -n "$(type -p mvn)" ]; then
	# see https://raw.github.com/dimaj/maven-bash-completion/master/bash_completion.bash
	$_bashrc_debug_echo "${BASH_SOURCE[0]}: using maven bash completion"
	function_exists()
	{
